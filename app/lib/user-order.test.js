const {parseOrder, UserOrder} = require('./user-order');
const {expect, test, describe} = require('@jest/globals');

/**
 * @param {UserOrder} actual - The returned value
 * @param {UserOrder} expected - The expected value
 */
function deepEquals(actual, expected) {
    expect(expected instanceof UserOrder).toBeTruthy();
    expect(actual instanceof UserOrder).toBeTruthy();
...
describe('parse function', () => {
    ...
    test('parses a valid request', () => {
        ...
        let validInput = '' +
            'BUY\n0.0001 BTC\n30000 USD'
        let expectedParse = new UserOrder(
            "BUY",
            "BTC",
            "USD",
            0.0001,
